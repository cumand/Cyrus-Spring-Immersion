...
public class PlayerControls : MonoBehaviour
{
    ...
    */
    ...
    void Update()
    {
        // 5. Declare a local variable of type float named 'horizontalInput'
        ...
        // 6. Declare a local variable of type float named 'vertricalInput'
        // Assign this variable the output of the Input.GetAxis("") function 
        ...
        // 7. Declare a local variable of type Vector3 named 'moveDirection'
        ...
        if (moveDirection != Vector3.zero)
        {
            ...
            // 9. Declare a local variable of type Quaternion named 'targetRotation'
            // Assign this variable the output of the function Quaternion.LookRotation(""), with the 'moveDirection' var as the argument
            ...
            // Pass in 'transform.rotation', 'targetRotation', 'rotationSpeed * Time.deltaTime' as the arguments/paremeters
